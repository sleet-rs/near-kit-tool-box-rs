...
pub struct PUMPOPOLY_NFT_METHODS_CONST_TYPE {
    pub new_default_meta: &'static str,
    pub new: &'static str,
    pub nft_sync: &'static str,
    pub nft_from_land: &'static str,
    pub nft_mint: &'static str,
    pub nft_mint_bond: &'static str,
    pub nft_payout: &'static str,
    pub nft_tokens_by_ids: &'static str,
    pub nft_token_ids_for_owners: &'static str,
    pub nft_tokens_ids: &'static str,
    pub nft_transfer_payout: &'static str,
    pub nft_transfer: &'static str,
    pub nft_transfer_call: &'static str,
    pub nft_token: &'static str,
    pub nft_resolve_transfer: &'static str,
    pub nft_approve: &'static str,
    pub nft_revoke: &'static str,
    pub nft_revoke_all: &'static str,
    pub nft_is_approved: &'static str,
    pub nft_total_supply: &'static str,
    pub nft_tokens: &'static str,
    pub nft_supply_for_owner: &'static str,
    pub nft_tokens_for_owner: &'static str,
    pub nft_metadata: &'static str,
}
// =================================================
// =================================================

// =================================================
/// Method name constants for the wrap.near wNEAR (NEP-141 wrapped NEAR) contract.
pub const WRAP_NEAR_METHODS_CONST: WRAP_NEAR_METHODS_CONST_TYPE = WRAP_NEAR_METHODS_CONST_TYPE {
...
// =================================================
/// String constants for wrap.near contract method names.
pub struct WRAP_NEAR_METHODS_CONST_TYPE {
    pub storage_minimum_balance: &'static str,
